...
export default {
  ...
  footerPaddingBottom: isIphoneX ? 34 : 8,

  // FooterTab
  tabBarTextColor: Colors.grayFour,
  activeTab: platform === "ios" ? "#007aff" : "#fff",
  sTabBarActiveTextColor: Colors.midBlue,
